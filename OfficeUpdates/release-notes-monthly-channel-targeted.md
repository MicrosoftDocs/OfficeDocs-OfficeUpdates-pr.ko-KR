...
- <div>함수를 동기적으로 실행하게 만드는 비동기적인 사용자 정의 함수의 성능 문제를 해결했습니다.</div>
...
- <h5>사용자 시나리오</h5><br><h5>결함</h5><br><h5>해결</h5><br><h5>개발/테스트 노트</h5><br><h5>코드 검토</h5><br>
...
- <div><span>복사한 페이지로의 링크가 새로 복사한 페이지가 아닌 원래 페이지로 이동시킬 수 있는 문제를 해결했습니다.</span></div>


### <a name="opc"></a>OPC

- <div><span></span></div><span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,sans-serif;">Internet Explorer에서 제한된 사이트에 대해 보호 모드가 해제된 경우 Outlook에서 부적절한 리소스 소비가 발생할 수 있는 문제를 해결했습니다.</span>
...
- <div><span>검색 결과에 확장된 비행 결과 검색이 표시되지 않도록 하는 문제를 해결했습니다</span></div>
...
- <div><span><span style="display:inline !important;background-color:rgba(255, 255, 255, 1);">프로젝트가 마스터 프로젝트를 통해 Project Web App에 저장될 때 하위 프로젝트 로컬 리소스, 요율 및 기타 속성이 저장되지 않던 문제를 해결했습니다.</span><br></span></div>
...
- <div><span>마스터 프로젝트가 있고 마스터 프로젝트의 로컬 사용자 정의 필드 값을 복사하여 삽입된 프로젝트에 붙여넣는 경우 일부 정보가 제대로 저장되지 않던 문제를 해결했습니다.</span></div>
...
- <div><span style="background-color:rgb(255, 255, 255);display:inline !important;">Outlook 기본 인증 프롬프트</span>에 로그인 이름이 이제는 미리 채워집니다</div>
...
## <a name="version-1910-october-24"></a>버전 1910: 10월 24일
*버전 1910 (빌드 12130.20238)*
...
- **Visio 데이터 시각화 도우미 Excel 추가 기능:** Excel 내에서 데이터를 세련된 Visio 다이어그램으로 쉽고 빠르게 시각화합니다. [자세한 정보](https://support.office.com/ko-KR/article/bee3b5aa-aaaf-4401-acc6-276b711c763c)
...
- 인쇄 미리 보기의 인쇄 영역이 올바르지 않았던 문제를 수정했습니다.

- 공동 작성 세션이 진행되는 동안 피벗 테이블을 새로 고칠 수 없었던 문제를 수정했습니다.
...
- 해당 기능을 사용하지 않도록 설정한 경우 버전 기록을 제공할 수 있었던 문제를 수정했습니다.
...
- Excel을 시작 시 가끔 중단이 되는 문제를 수정했습니다.
...
- 처음으로 문서를 저장한 후 도구 조언이 제대로 표시되지 않는 문제를 수정했습니다.
...
- Internet Explorer에서 제한된 사이트에 대해 보호 모드가 해제되었을 때 Outlook에서 부적절한 리소스 사용을 일으킬 수 있는 문제를 해결 했습니다.
