---
title: 2017년 월별 채널 릴리스에 대한 릴리스 정보
ms.author: anankani
author: andymosten
manager: anankani
ms.date: 7/11/2018
...
이러한 릴리스 정보는 2017년 Office 365 ProPlus에 대한 월별 채널 업데이트에 포함된 새로운 기능, 보안 업데이트 및 비보안 업데이트에 대한 정보를 제공합니다.
...
## <a name="version-1711-december-12"></a>버전 1711: 12월 12일
...
## <a name="version-1711-december-6"></a>버전 1711: 12월 6일
...
-   **4K로 내보내기:** 프레젠테이션을 비디오로 내보낼 때 Ultra HD(4K)가 해상도 옵션입니다.
...
## <a name="version-1710-november-27"></a>버전 1710: 11월 27일
...
## <a name="version-1710-november-20"></a>버전 1710: 11월 20일
...
## <a name="version-1710-november-14"></a>버전 1710: 11월 14일
...
## <a name="version-1710-november-2"></a>버전 1710: 11월 2일
...
-   **웹 사이트에 대한 와이어프레임 다이어그램 만들기:** 인터페이스, 탐색 및 작동 방식을 비롯한 웹 사이트의 와이어프레임 다이어그램을 신속하게 만듭니다. [추가 정보](https://support.office.com/article/2d54dc55-f5c4-49a2-85da-d649eb7fc281)
...
### <a name="word-feature-updates"></a>Word: 기능 업데이트
-   **Microsoft Translator:** Word에서 Microsoft Translator를 사용하여 단어, 구문 또는 문서 전체를 다른 언어로 번역합니다.[추가 정보](https://support.office.com/article/24a987b3-03a1-4c17-8c1b-54495fca6b17)
-   **디지털 펜슬:** 새로운 연필 텍스처로 아이디어를 쓰거나 스케치하세요. 지원되는 디지털 펜을 기울여서 음영을 표현하세요.
...
## <a name="version-1709-october-25"></a>버전 1709: 10월 25일
...
## <a name="version-1709-october-16"></a>버전 1709: 10월 16일
*버전 1709(빌드 8528.2139)*

### <a name="powerpoint-feature-updates"></a>PowerPoint: 기능 업데이트
-   **디지털 펜으로 슬라이드 쇼 실행:** Surface 펜 또는 Bluetooth 단추가 있는 기타 펜을 사용하여 슬라이드를 넘깁니다. Windows 10 가을 크리에이터 업데이트가 필요합니다. [추가 정보](https://support.office.com/article/e36da834-7d34-4b71-aafd-071727549f7a)
...
### <a name="visio-feature-updates"></a>Visio: 기능 업데이트
-   **데이터 시각화 도우미 다이어그램에 데이터 그래픽 적용:** 도형 데이터를 자동으로 데이터 그래픽으로 적용하여 데이터 시각화 도우미 다이어그램을 만들 때 시간을 절약할 수 있습니다. [추가 정보](https://support.office.com/article/17211b46-d144-4ca2-9ea7-b0f48f0ae0a6?#apply_dg)
-   **그리기 공동 작업** 비즈니스용 OneDrive 또는 SharePoint Online에서 다른 사용자와 그림을 공유하여 함께 작업합니다. 그리기 작업 중인 사람을 확인하고 메모를 추가하거나 파일 활동을 볼 수 있습니다. [추가 정보](https://support.office.com/article/413c0b5a-0d52-4ace-af85-8b9bf115bbbf)
...
## <a name="version-1708-october-4"></a>버전 1708: 10월 4일
...
-   자동 저장 토글이 표시되지 않는 문제를 수정합니다.
-   OneDrive, 비즈니스용 OneDrive 또는 동기화 클라이언트를 사용하 여 동기화되는 SharePoint에 저장한 파일을 여는 경우 자동 저장을 제대로 사용하지 못하게 되거나 회색으로 표시되는 문제를 수정합니다.
...
## <a name="version-1708-september-18"></a>버전 1708: 9월 18일
...
## <a name="version-1707-september-12"></a>버전 1707: 9월 12일
...
## <a name="version-1707-august-29"></a>버전 1707: 8월 29일
...
## <a name="version-1707-august-24"></a>버전 1707: 8월 24일
...
## <a name="version-1707-august-18"></a>버전 1707: 8월 18일
...
## <a name="version-1707-august-11"></a>버전 1707: 8월 11일
...
## <a name="version-1707-august-7"></a>버전 1707: 8월 7일
...
## <a name="version-1707-july-31"></a>버전 1707: 7월 31일
...
## <a name="version-1707-july-28"></a>버전 1707: 7월 28일
...
## <a name="version-1707-july-27"></a>버전 1707: 7월 27일
...
-   **자동 도청:** 변경 내용은 클라우드에 저장된 통합 문서에 대해 자동으로 저장되며 다른 통합 문서의 업데이트를 초당 볼 수 있습니다. [추가 정보](https://support.office.com/article/6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5)
...
### <a name="powerpoint-feature-updates"></a>PowerPoint: 기능 업데이트
-   **AutoSave:** 변경 사항은 클라우드에 저장된 프레젠테이션에 자동으로 저장되며 다른 사용자의 업데이트를 몇 초 만에 볼 수 있습니다. [추가 정보](https://support.office.com/article/6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5)
...
### <a name="word-feature-updates"></a>Word: 기능 업데이트
-   **학습 도구를 사용한 편집:** 이제 Word의 웹 모양에서 학습 도구를 사용할 수 있습니다. 편집하는 동안 텍스트 간격을 조정하고 음절을 표시합니다. 모든 뷰에서 문서를 소리내어 읽을 때 각 단어가 강조 표시되는 것을 확인합니다. [추가 정보](https://support.office.com/article/a857949f-c91e-4c97-977c-a4efcaf9b3c1)
-   **LaTeX 구문:** LaTeX 구문을 사용하여 수학식을 만들고 편집합니다.
-   **유용한 사운드로 접근성 향상:** 오디오 신호를 켜면 작업할 때 안내를 받을 수 있습니다. 파일 \> 옵션 \> 접근성에서 확인할 수 있습니다. 추가 기능은 필요하지 않습니다. [추가 정보](https://support.office.com/article/49fda9be-cce5-4c72-a87f-b11000197f5f)
-   **계정별 파일 위치:** 파일을 열거나 저장할 때 위치 목록이 연결된 계정을 기준으로 구성됩니다.

### <a name="office-suite-non-security-updates"></a>Office 제품군: 비보안 업데이트
-   mscomctl.ocx에 대한 64비트 지원을 추가하여 64비트 버전의 Office에서 작업하는 사용자가 일반 컨트롤이 포함된 매크로 파일을 만들고, 편집하고 열 수 있습니다.
-   mscomctl.ocx에서 사용되는 컨트롤의 가용성을 개선합니다.



## <a name="version-1706-july-19"></a>버전 1706: 7월 19일
...
## <a name="version-1706-july-13"></a>버전 1706: 7월 13일
...
## <a name="version-1706-june-28"></a>버전 1706: 6월 28일
...
## <a name="version-1705-june-7"></a>버전 1705: 6월 7일
*버전 1705(빌드 8201.2075)*

### <a name="excel-feature-updates"></a>Excel: 기능 업데이트
-   **복사본 유지**: 셀을 복사합니다. 그러면 붙여 넣기 전에 셀 입력 또는 삽입과 같은 기타 작업을 여전히 수행할 수 있습니다.
...
## <a name="version-1704-may-18"></a>버전 1704: 5월 18일
...
### <a name="outlook-feature-updates"></a>Outlook: 기능 업데이트
-   **중요 받은 편지함:** 받은 편지함은 두 개의 탭, 중요 받은 및 기타로 분리됩니다. 메시지는 메시지의 콘텐츠와 가장 자주 상호 작용하는 사람을 기준으로 정렬됩니다. [추가 정보](https://support.office.com/article/f445ad7f-02f4-4294-a82e-71d8964e3978)
...
## <a name="version-1703-may-9"></a>버전 1703: 5월 9일
...
## <a name="version-1703-april-21"></a>버전 1703: 4월 21일
...
### <a name="excel-non-security-updates"></a>Excel: 비보안 업데이트
-   TEXTJOIN, CONCAT, IFS, MAXIFS, 그리고 MINIFS와 같이 Office 2016 출시 이후 도입 된 새로운 기능들이 누락 된 문제를 해결합니다.
...
### <a name="powerpoint-feature-updates"></a>PowerPoint: 기능 업데이트
-   **QuickStarter:** 사용자가 선택한 주제에 대해 연구를 시작하는 데 도움이 되는 개요를 자동으로 작성합니다. [추가 정보](https://support.office.com/article/4784f273-0b2c-456c-9c89-24e5b977c224)
-   **공유 파일 작업:** 파일의 오른쪽 위 구석에 있는 작업 단추를 선택하면 비즈니스용 OneDrive 또는 SharePoint에서 공유되는 파일을 공유하거나, 편집하거나, 이름을 바꾸거나, 복원하는 경우를 알 수 있습니다.
...
## <a name="version-1702-april-11"></a>버전 1702: 4월 11일
...
## <a name="version-1702-march-27"></a>버전 1702: 3월 27일
...
## <a name="version-1702-march-14"></a>버전 1702: 3월 14일
...
## <a name="version-1702-march-9"></a>버전 1702: 3월 9일
...
### <a name="powerpoint-feature-updates"></a>PowerPoint: 기능 업데이트
-   **디지털 눈금자:** 터치 스크린이 있는 장치에서 그리기 \> 눈금자로 이동한 후 펜이나 손가락을 이용하여 직선을 그리거나 개체 집합을 정렬할 수 있습니다. [추가 정보](https://support.office.com/article/6222c9b4-2fdf-48f7-a3fd-1687fbe2bf84)
-   **배경 제거:** 자유 형식 그리기 도구를 사용하여 배경 그림을 제거합니다.
...
-   화이트 보드에서 주석을 가리킬 때 작성자 및 수정자 이름이 안 나타나는 문제를 해결합니다.
...
### <a name="word-non-security-updates"></a>Word: 비보안 업데이트
-   각주의 위 첨자 번호가 올바르지 않은 세로의 위치에 있는 문제를 해결합니다.
-   추가 기능이 업그레이드된 후 혹은 Office 스토어에서 추가기능을 제거하고 다시 다운로드 받고 난 후 추가 기능 명령 단추가 작동하지 않는 문제를 해결합니다.



## <a name="version-1701-february-23"></a>버전 1701: 2월 23일
...
## <a name="version-1612-january-31"></a>버전 1612: 1월 31일
...
## <a name="version-1612-january-25"></a>버전 1612: 1월 25일
