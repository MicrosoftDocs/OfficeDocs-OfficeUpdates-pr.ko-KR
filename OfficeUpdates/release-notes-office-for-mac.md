...
**참고:** Microsoft AutoUpdate(MAU) 릴리스 정보는 [MAU 릴리스 기록](https://docs.microsoft.com/officeupdates/release-history-microsoft-autoupdate) 페이지로 이동했습니다.<br/>
 ...
 **릴리스 날짜:** 2016년 12월 15일 
  
 *버전 15.29.1(빌드 16121500)* 
  
이 릴리스는 파일 경로의 첫 부분에 공백이나 특정 문자가 포함되어 있는 경우 Word, Excel 또는 PowerPoint에서 파일을 열거나 저장할 때 발생하는 문제를 해결합니다.

<br/><br/>
  
 **릴리스 날짜:** 2016년 12월 13일 
  
 *버전 15.29.0(빌드 16120900)* 
  
이 릴리스는 다음과 같은 업데이트를 제공합니다.
  
|**응용 프로그램**|**기능 업데이트**|**비보안 업데이트**|**보안 업데이트**|
|:-----|:-----|:-----|:-----|
|Word  <br/> | PDF로 변환할 때 하이퍼링크가 계속 작동하면서 문서 재현성이 유지됩니다. [자세한 정보](https://support.office.com/article/aa183751-1f09-4b8b-88a4-099a0c7528da) <br/>  <br/> 접근성 높은 문서를 만들고, 문서를 읽고 편집하기 위한 기타 보조 기술과 VoiceOver를 사용하기 위한 지원이 개선되었습니다. [자세한 정보](https://support.office.com/article/c681eb25-549e-4d1d-a970-e52450c701de) |
 ...
 *버전 15.28.0(빌드 16111700)* 
  
이 릴리스는 Exchange Server 2010의 Outlook 및 공용 폴더 관련 문제를 해결합니다. 

<br/><br/>
  
 **릴리스 날짜:** 2016년 11월 15일 
  
 *버전 15.28.0(빌드 16111501)* 
 ...
 *버전 15.28.0(빌드 16111300)* 
  
이 릴리스는 다음과 같은 업데이트를 제공합니다.
  
|**응용 프로그램**|**기능 업데이트**|**비보안 업데이트**|**보안 업데이트**|
|:-----|:-----|:-----|:-----|
|Word  <br/> |체코어, 헝가리어, 한국어, 노르웨이어, 폴란드어, 러시아어, 터키어에 대한 새 문법이 지원됩니다.  <br/> | 특정 테두리 콘텐츠가 있는 Excel 스프레드시트가 문서에 포함될 경우 Word에서 문서를 저장하지 못하는 문제를 해결합니다.  <br/> |Microsoft 보안 공지 [MS16-133](https://technet.microsoft.com/library/security/MS16-133): Microsoft Office용 보안 업데이트(3199168) |
...
|PowerPoint  <br/> |Windows용 PowerPoint 2016에서 확대/축소 명령을 사용하여 만든 대화형 요약 및 자동 탐색 링크를 봅니다.  <br/> | 이미지가 렌더링되지 않고 및 rID#으로 참조되는 오류로 바뀌는 문제를 해결합니다.  ||
|Outlook  <br/> |접근성 검사를 사용하여 이미지나 초대를 작성할 때 발생하는 접근성 문제를 찾아서 해결합니다. [자세한 정보](https://support.office.com/article/3b84295e-d55b-49f1-b443-523ec45a5232) <br/> | 전자 메일을 작성할 때 자동 언어 검색 관련 문제를 해결합니다. ||
|Office 제품군  <br/> || - 접근성 요구 사항이 있는 사용자에 맞게 획기적으로 개선되었습니다.  <br/><br/>  - 마지막 충돌 로그를 디스크에 저장하도록 Microsoft 오류 보고를 구성할 수 있습니다(기본값 com.microsofterrorreporting IsStoreLastCrashEnabled -bool TRUE). <br/> <br/>  - E1/K1 사용자에 대한 정품 인증 메시지가 개선되었습니다. 더 이상 오류가 발생되었다고 표시되지 않으며 보기 전용 환경이제 공됩니다.  <br/><br/> - 설치 관리자 및 업데이트 관리자 파일 이름 형식이 변경되었습니다. 예를 들어 Microsoft_Office_2016_15.28.0_161113_Installer.pkg 대신 Microsoft_Office_2016_15.28.16111300_Installer.pkg가 사용됩니다.  ||
|Microsoft 자동 업데이트  <br/> |업데이트를 자동으로 감지, 다운로드 및 설치하기 위한 새로운 옵션이 포함되어 있습니다.  <br/> | - 버전 번호가 3.8.1로 업데이트되었습니다.  <br/> <br/>- 이전 버전의 Microsoft Silverlight가 설치되어 있을 때 MAU가 작동 중단될 수 있는 문제를 수정합니다. 특히 Silverlight가 null LCID로 등록된 경우의 문제가 해결되었습니다.  <br/><br/>  - ManifestServer 기본 설정을 사용할 때 MAU가 작동 중단될 수 있는 문제를 수정합니다.  <br/><br/> - Microsoft AU 디먼 번들 표시 이름이 "Microsoft 업데이트 도우미"로 변경되었습니다.  <br/><br/> - 2016 앱용 MAU XML 피드가 더 이상 트리거 사전을 포함하지 않으며 버전 검색을 위해 "업데이트 버전"을 활용합니다.  <br/><br/> - MAU가 이제 앱 업데이트 창에 전체 버전 문자열을 표시합니다. 예를 들어 15.28이 아니라 15.28.16110300을 표시합니다.  ||
