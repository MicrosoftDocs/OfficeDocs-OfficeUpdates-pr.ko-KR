...
---
# <a name="archived-release-notes-for-monthly-enterprise-channel"></a>월 단위 기업 채널의 보관된 릴리스 정보
이 릴리스 정보는 Office 365용 Visio Pro, Project Online 데스크톱 클라이언트 및 비즈니스용 Office 365 앱을 비롯한 Office 365 ProPlus의 월 단위 기업 채널 업데이트에 포함된 새로운 기능 및 비보안 업데이트에 관한 정보를 제공합니다.
